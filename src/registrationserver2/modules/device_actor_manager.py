...
from registrationserver2.modules.device_base_actor import RETURN_MESSAGES, DeviceBaseActor
...
DEVICE_ACTOR_MANAGER : ActorAddress =  actor_system.createActor(DeviceActorManager,type(DeviceActorManager).__name__)
