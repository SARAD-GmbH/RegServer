...
RETURN_MESSAGES = {
        ...
        'CONNECTION_FAILURE' : {"ERROR":"MQTT client failed to connect to MQTT-broker", "ERROR_CODE" : 6}, 
        'CONNECTION_NO_RESPONSE' : {"ERROR":"No response to connection request", "ERROR_CODE" : 7}, 
        #'DISCONNECTION_FAILURE' : {"ERROR":"MQTT client failed to disconnect with MQTT-broker", "ERROR_CODE" : 8}, 
        #'DISCONNECTION_NO_RESPONSE' : {"ERROR":"No response to disconnection request", "ERROR_CODE" : 9}, 
        'PUBLISH_FAILURE' : {"ERROR":"Failed to publish the message", "ERROR_CODE" : 10},
        'SUBSCRIBE_FAILURE' : {"ERROR":"Failed to subscribe to the topic", "ERROR_CODE" : 11},
        'UNSUBSCRIBE_FAILURE' : {"ERROR":"Failed to unsubscribe to the topic", "ERROR_CODE" : 12},
        #################################################################
